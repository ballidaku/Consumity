package app.abhilasha.consumity.com.consumity.Async_Thread;
...
public class Super_AsyncTask extends AsyncTask<Void, Void, String>
{
  ...
  /*  public void cancelAsync()
    ...
    protected void onPostExecute(String ResponseString)
    {
        ...
        {
            GlobalConstant.show_Toast("Please check your network.", con);
        }
        else if (ResponseString.equals("ERROR"))
        {
            GlobalConstant.show_Toast("Server side error.", con);
        }

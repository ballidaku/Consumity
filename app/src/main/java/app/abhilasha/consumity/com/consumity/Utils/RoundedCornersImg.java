...
public class RoundedCornersImg extends ImageView
{
	...
	public RoundedCornersImg(Context context)
	{
		super(context);

	}

	public RoundedCornersImg(Context context, AttributeSet attrs)
	{
		super(context, attrs);

	}

	public RoundedCornersImg(Context context, AttributeSet attrs, int defStyle)
	{
	...
	public void setImageUrl(Context con, String URL)
	{
		...
		if(drawable==0)
		{
			drawable= R.mipmap.ic_profile_placeholder;
		}
